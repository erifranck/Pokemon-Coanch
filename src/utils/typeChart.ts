// Multipliers: 2 = Super Effective (x2), 1 = Neutral (x1), 0.5 = Not Very Effective (x0.5), 0 = Immune (x0)
// Row: Attacking Type
...
export const calculateDefensiveMultiplier = (attackingType: string, defendingTypes: string[]): number => {
  let multiplier = 1;
