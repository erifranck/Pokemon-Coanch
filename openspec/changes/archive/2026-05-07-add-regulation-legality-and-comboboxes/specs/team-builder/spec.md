...
#### Scenario: Identifying Illegal Selections
- **WHEN** the Pokémon Card detects that a currently selected Move, Item, or Ability is illegal in the Team's selected Regulation
- **THEN** the corresponding Combobox input is styled with red visual cues to warn the user without deleting the data.